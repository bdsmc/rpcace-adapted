...
define( 'COINNAME', 'yourcoin' );
define( 'COINHOME', 'http://explorer.yourcoin.com/index.php' );
...
class COINNAME
{
    ...
    private static $rpcPort = 9999;
    private static $rpcUser = 'yourcoinrpc';
    private static $rpcPass = '7FnxgKE5GqEDLeqYsihsujki3taLXVVKQhHtng9BfdGb';
    ...
    private function base()
    {
        ...
        $output['rpcace_version'] = COINNAME;
...
<?php
/*
   This is the example block explorer.
*/

$query = substr( @$_SERVER['QUERY_STRING'], 0, 64 );

if( strlen($query) == 64 )
    $ace = COINNAME::getBlock( $query );
else
{
    $query = ( $query === false || !is_numeric($query) ) ? null : abs( (int)$query );
    $ace = COINNAME::getBlockList( $query, BLOCKSPERLIST );
...
<!DOCTYPE html>
<!--
    YOURCOIN  // details for google in header, which can be expanded, header and link to github 217 and CSS all below

    (c) 2017 YOURCOIN DEVELOPERS

    https://github.com/yourcoin
-->
<head>
<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<meta name="robots" content="index" />
<meta name="author" content="yourcoin.com" />

END;

if( empty($query) || ctype_digit($query) )
    echo '<meta http-equiv="refresh" content="' . REFRESHTIME . '; url=' . basename( __FILE__ ) . "\" />\n";
echo '<title>' . COINNAME . ' block explorer' .  "</title>\n";
...
tr.illu:hover { background-color: #fff000; }
</style>
</head>
<body>
<div class="mid">
...
$diffNom = 'Difficulty';
$diff = sprintf( '%.3f', $ace['current_difficulty_pos'] );
if( COINPOS )
{
    $diffNom .= ' &middot; PoS';
...
echo '<tr><td>Powered by <a href="https://github.com/yourcoin/" target="_blank">LOVE</a> v' . x . ' </td><td>Network hashrate: </td><td>' . $ace['hashrate_mhps'] . ' MH/s</td></tr><tr><td> </td><td></td><td></td></tr></table>';
